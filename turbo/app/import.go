...
func InsertChain(ethereum *eth.Ethereum, chain *core.ChainPack) error {
	...
	_, err := stages.StageLoopStep(ethereum.SentryCtx(), ethereum.ChainDB(), ethereum.StagedSync(), highestSeenHeader, ethereum.Notifications(), initialCycle, sentryControlServer.UpdateHead, nil, nil)
	if err != nil {
		return err
	}
